...
var CountRoll = function (_Component) {
  ...
  function CountRoll(props) {
    ...
    _this.state = {
      valueStart: (0, _util.formatNumber)(_this.props.start, _this.props.decimals, _this.props.useGroup),
      height: 'auto',
  ...
  _createClass(CountRoll, [{
    ...
    value: function __getAllCount__REACT_HOT_LOADER__() {
      ...
      for (var i = 0; i < 19; i += 1) {
        ...
        if (t < this.props.duration) {
          ...
          result = (0, _util.formatNumber)(this.props.count, this.props.decimals, this.props.useGroup);
        }
        arr.unshift(result);
      }
    ...
    value: function __setInit__REACT_HOT_LOADER__(maxHeight, start, decimals, useGroup) {
      this.setState({
        ...
        valueStart: (0, _util.formatNumber)(start, decimals, useGroup)
      });
    }
  }, {
    key: '__setAnimationStyle__REACT_HOT_LOADER__',
    ...
    value: function __countUp__REACT_HOT_LOADER__(t, b, c, d) {
      ...
      return (0, _util.formatNumber)(result, decimals, useGroup);
    }
  }, {
    key: 'render',
