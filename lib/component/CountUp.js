...
var AnimationCount = function (_Component) {
  ...
  function AnimationCount(props) {
    ...
    _this.state = {
      value: (0, _util.formatNumber)(_this.props.start, _this.props.decimals, _this.props.useGroup),
  ...
  _createClass(AnimationCount, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      var propsFlag = !(0, _util.equalObject)(this.props, nextProps);
      if (propsFlag) {
        this.setState({
          value: (0, _util.formatNumber)(this.props.start),
          startTime: new Date().getTime()
        });
        this.clearTimer();
        this.setTimer();
      ...
      var stateFlag = !(0, _util.equalObject)(this.state, nextState);
      if (stateFlag) {
        return true;
      }
      return false;
    ...
    value: function __setTimer__REACT_HOT_LOADER__() {
      ...
      this.timer = setInterval(function () {
        ...
        if (t < _this2.props.duration) {
          ...
          result = (0, _util.formatNumber)(_this2.props.count, _this2.props.decimals, _this2.props.useGroup);
    ...
    value: function __countUp__REACT_HOT_LOADER__(t, b, c, d) {
      ...
      result = (0, _util.formatNumber)(result, this.props.decimals, this.props.useGroup);
      return result;
    }
  }, {
    key: 'render',
